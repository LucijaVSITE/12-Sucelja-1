...
namespace Vsite.CSharp
{
    public class ImplicitnaEksplicitnaPretvorba
    {
        static void Main(string[] args)
        {
            ...
            // Napisati naredbu koja će pomoću metode Queue<T>.Enqueue() dodati još jedan element
            // u 'red' 
            red.Enqueue("Pero");
        ...
        {
            // Napraviti eksplicitnu pretvorbu proslijeđenog argumenta 
            // u ICollection i ispisati broj elemenata.
